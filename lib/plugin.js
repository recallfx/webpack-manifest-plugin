...
ManifestPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin('emit', function(compilation, compileCallback) {
    ...
    if (this.opts.basePath || this.opts.baseSourcePath || this.opts.baseDestPath) {
      cache = _.reduce(cache, function(memo, value, key) {
        memo[this.opts.basePath + this.opts.baseSourcePath + key] = this.opts.basePath + this.opts.baseDestPath + value;
        return memo;
      }.bind(this), {});
    }
